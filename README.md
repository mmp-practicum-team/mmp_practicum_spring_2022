...
* $B_{fall}$ — баллы за осенний семестр, $B_{fall, max} = 230$ — максимальное число баллов за осенний семестр.
* $B_{spring}$ — баллы за весенний семестр, $B_{spring, max} = 45$ — максимальное число баллов за весенний семестр.
* $B = 3 \frac{B_{fall}}{B_{fall, max}} + 7 \frac{B_{spring}}{B_{spring, max}}$ — баллы за годовой курс.

$$
\text{Оценка} = \begin{cases}
  B \ge 8 \;\text{и}\;5\;\text{практических заданий сданы на оценку} \ge 4 \Rightarrow \text{отлично} \\
  B \ge 6 \;\text{и}\;4\;\text{практических задания сданы на оценку} \ge 4 \Rightarrow \text{хорошо} \\
  B \ge 4 \;\text{и}\;3\;\text{практических задания сданы на оценку} \ge 4  \Rightarrow \text{удовлетворительно} \\
  \text{иначе} \Rightarrow \text{неудовлетворительно}
  \end{cases}
$$
